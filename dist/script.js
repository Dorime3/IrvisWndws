...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (item) {
    // перебираем инпуты для телефонов
...
var forms = function forms(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); // ввод цифр в поле ввода для телефона
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // метод для отправки данных с форм (1арг - адрес, 2арг - данные, кторые мы собрали с помощью метода new FormData)
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      if (item.getAttribute('data-calc') === 'end') {
        // отслеживаем форму с выбором профиля и размеров окон.
      ...
      .then(function (res) {
        console.log(res);
        statusMessage.textContent = message.success; // если успешно
      }).catch(function () {
...
var images = function images() {
  ...
  var worksField = document.querySelector('.works');
  ...
  worksField.addEventListener('click', function (e) {
    e.preventDefault();
